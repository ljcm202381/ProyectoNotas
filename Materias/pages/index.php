    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
      ...
      <h2>BIENVENIDO:<?php echo $_SESSION['NOMBRE'];?></h2>
        <div class="container">
 <h1 style="color:blue;text-align:center;">LISTADO DE MATERIALES</h1>
  ...
  foreach ($datos as $key){
               ...
               ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $key["Nombremate"] ?></td>
                       
                       <td> <a href="editar.php?Id=<?php echo $key['id_Materia']?>" class="btn btn-success">Actualizar</a>

                       </td>
                        
                        <td>
                         <td> <a href="eliminar.php?Id=<?php echo $key['id_Materia']?>" class="btn btn-success">Eliminar</a>
